...
**Build.** Engine 2, size M. Reuses the Wedding Timeline / Seating Chart PDF pipeline; the real work is 3 to 4 tasteful templates and the imposition math.

**Timing.** Evergreen, zero seasonality, ships any month and starts compounding immediately. Anchors the hardest-week group (see #2 to 4).
...
**Who's searching.** People 45 to 70 finally getting organized, adults after a health scare, new parents. They type *emergency binder template free*, *in case of death organizer*, *nokbox alternative*.
...
**Caution.** The biggest content grind proposed, dozens of guided sections is weeks of form work for one person. Ship 4 to 5 sections with a completeness checklist and grow it.
...
**Tip logic.** The most concrete ask in the suite: the incumbents would have taken 3 to 5% of the pot, the tipper literally has Venmo open, and they're already in a giving mindset.
...
Honest note on search lead time: SEO takes 2 to 4 months to compound, so this fall these apps live on community seeding (r/Teachers and building-level word of mouth for Sub Plans, office and party organizers for Squares) while the pages index toward flu season, the playoffs, and next August.
