...
const ASSETS = ['./', './index.html', './app.js', './data.js', './helpers.js',
  ...
  'https://www.gstatic.com/firebasejs/12.17.1/firebase-firestore.js', "./sws-prefs.js"];
...
self.addEventListener('fetch', (e) => {
  ...
  e.respondWith(caches.match(e.request, { ignoreSearch: url.origin === location.origin }).then((cached) => {
