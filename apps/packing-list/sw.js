...
const VERSION = 'pack-v15';
const ASSETS = ["./","./app.js","./apple-touch-icon.png","./helpers.js","./icon.svg","./index.html","./manifest.webmanifest","./vendor-qrcode.js", "./sws-prefs.js", "./sws-ui.js"];
