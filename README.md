...
can derive is derived, from the same source of truth the design system uses, `skins.mjs` for identity, `palette.json` for the solved colours, each app's own
...
an *organisation* under SWS Strategic Media LLC, verification takes 2 to 4 weeks and
